...
const rowsPlanung = [
  ...
  { id: 110, unternehmen: 'bauart', land: 'D', plz: '36341', standort: 'Lauterbach', web: "https://www.bauart-ingenieure.de/" , zertifizierung: true, energietechnik: true, lca: true, lcc: true, tga: false, sanierung: true, schallschutz: true, tga: true, bauphysik: true, ansprechperson: '-', email: '-'},
